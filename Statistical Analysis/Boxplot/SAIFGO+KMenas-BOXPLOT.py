# ==========================================================
# IFGO + K-MEANS + BOXPLOT VISUALIZATION (ONE IMAGE ONLY)
# ==========================================================
...
plt.title(f"Boxplot of {feature_name} Across Clusters (Shopping Dataset)") # Change
plt.xticks(range(1, n_clusters + 1), [f"C{c}" for c in range(n_clusters)])
plt.tight_layout()

output_file = "SAIFGO+KMeans+Shopping.jpg" # Change
