# ==========================================================
# IFGO + FCM + BOXPLOT VISUALIZATION (ONE IMAGE)
# ==========================================================
...
if __name__ == "__main__":
    ...
    plt.title(f"Boxplot of {feature_name} Across Clusters (Wave Dataset)") # Change
    plt.xticks(range(1, model.n_clusters + 1),
