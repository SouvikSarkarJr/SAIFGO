# ==========================================================
# IFGO + FCM + INDEPENDENT T-TEST + LINE GRAPH (JPG)
# ==========================================================
...
from scipy.stats import levy, ttest_ind
import random
import os
...
if __name__ == "__main__":
    ...
    plt.title("T-Test (SAIFGO + FCM)")
    plt.xlabel("Features (Wave Dataset)")
    plt.ylabel("P-values")
    plt.tight_layout()

    output_file = "SAIFGO+FCM.jpg"
