# ==========================================================
# IFGO + FCM + FRIEDMAN TEST + JPG SAVE (FULL VERSION)
# ==========================================================
...
if __name__ == "__main__":
    ...
    file_path = "Data-sets/Shopping.csv"   # Change
    ...
    plt.title("Friedman Test Across Clusters")
    plt.xlabel("Features (Shopping Dataset)") # Change
    plt.ylabel("P-values")
    plt.tight_layout()

    save_path = os.path.join(os.getcwd(), "SAIFGO+FCM+Shopping.jpg") # Change
