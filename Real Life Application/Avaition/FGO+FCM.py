...
ax.set_title("Domestic Flight Network and Airport Across India (using FGO+FCM)", 
             fontsize=20, fontweight="bold", pad=15)
fig.text(0.5, 0.05, "(a) Aviation Network Using FGO+FCM", 
...
output_path = os.path.join(output_dir, "FGO_FCM.png")
