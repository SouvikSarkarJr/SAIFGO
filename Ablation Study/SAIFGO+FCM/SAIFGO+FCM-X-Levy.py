...
csv_path = "/Users/souviksarkarjr./Downloads/Dataset/Shopping.csv"   # CSV File Path
n_clusters = 3
...
fcm_m = 2.0           # Fuzzy fuzzifier parameter ( Lowered from 2.0 to 1.2 to force harder cluster assignments )
...
# Reduced to track 2 strategies instead of 3
...
for t in range(max_iter):
    ...
    # Adapted to only pick between strategy 0 and 1
