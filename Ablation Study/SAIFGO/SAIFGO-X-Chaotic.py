...
for _ in range(pop_size):
    ...
    for m in range(D):
        ...
        Z_primary[m] = LB[m] + random.random() * (UB[m] - LB[m])
        
    raw_pool.append(Z_primary)
    raw_pool.append(LB + UB - Z_primary) # OBL remains intact
...
for t in range(max_iter):
    ...
    # Pre-generate strategies and random choice items to save loop runtime
