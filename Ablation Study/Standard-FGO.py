...
# PARAMETERS
# ==========================
csv_path = "/Users/souviksarkarjr./Downloads/Experimental Datasets/Delivery.csv"

n_clusters = 3
pop_size = 30
max_iter = 100

# STANDARD FGO PARAMETER: Constant parameter setup instead of adaptive tuning
R_static = 0.5 
...
# ==========================
# STANDARD FGO OPTIMIZATION LOOP
# ==========================
for t in range(max_iter):

    print(
        f"Iteration {t+1}/{max_iter} | "
        f"Static Coefficient (R): {R_static:.2f} | "
    ...
    for i in range(pop_size):
        ...
        # Standard FGO mutation/position formula utilizing static constant multiplier
        new_solution = Xi + R_static * np.random.rand() * (population[j] - population[k])
