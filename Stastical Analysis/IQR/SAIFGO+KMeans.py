# ==========================================================
# SAIFGO + K-Means + KRUSKAL-WALLIS + MEDIAN & IQR
# ==========================================================
...
if __name__ == "__main__":
    ...
    if not os.path.exists(file_path):
        ...
        model = SAIFGO_KMeans_Clustering(n_clusters=3, pop_size=20, max_iter=30)
        model.fit(X_scaled)
        ...
        if len(results) == 0:
            ...
            for idx, (feature_name, medians, iqrs) in enumerate(results):
                ...
                plt.title(f"Median ± IQR - {feature_name} (SAIFGO+KMeans)")
