# ==========================================================
# SAIFGO + FCM + CONVERGENCE CURVE ANALYSIS
# ==========================================================
...
def saifgo_optimize(X, n_clusters=3, pop_size=25, max_iter=60):
...
if __name__ == "__main__":
    ...
    # Step 1: SAIFGO
    initial_centers = saifgo_optimize(X_scaled)
    ...
    plt.title("SAIFGO + FCM Convergence Curve (# Dataset)")
    plt.tight_layout()
