...
# ==========================================================
# 6. K-MEANS REFINEMENT
# ==========================================================
print("Refining solution using K-Means...")
...
final_Z = kmeans.cluster_centers_.flatten()
...
plt.title(f"Boxplot of {feature_name} Across Clusters (SAIFGO+K-Means)") 
plt.xticks(range(1, n_clusters + 1), [f"C{c}" for c in range(n_clusters)])
plt.tight_layout()

save_path = os.path.join(os.getcwd(), "SAIFGO+KMeans.jpg")
