# ==========================================================
# SAIFGO + FCM + BOXPLOT VISUALIZATION
# ==========================================================
...
# ==========================================================
file_path = "/Users/souviksarkarjr./Downloads/Experimental/Shopping.csv"   # Change
n_clusters = 3
...
if not os.path.exists(file_path):
    raise FileNotFoundError("Dataset not found. Please update 'file_path'.")

df = pd.read_csv(file_path)

# Drop ID columns and select numeric
...
# Scale data (Optimization done on scaled data)
scaler = MinMaxScaler()
...
# ==========================================================
print("Starting SAIFGO Optimization...")
...
# ==========================================================
# 6. FUZZY C-MEANS REFINEMENT
# ==========================================================
print("Refining solution using FCM...")
...
def fuzzy_c_means(data, initial_Z, m=2.0, max_iter=100, error=1e-5):
    ...
    return centroids.flatten(), np.argmax(U, axis=1)

final_Z, final_labels = fuzzy_c_means(data, best_Z, fcm_m, fcm_iter)
...
print(f"Optimized Composite Score: {final_score:.6f}")
print(f"Execution Time: {execution_time:.4f} seconds")

# ==========================================================
# 7. BOXPLOT VISUALIZATION
# ==========================================================
# Add labels to unscaled original data
X_original = pd.DataFrame(X, columns=features)
X_original["Cluster"] = final_labels
...
plt.title(f"Boxplot of {feature_name} Across Clusters (SAIFGO+FCM)") 
