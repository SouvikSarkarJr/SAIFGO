# ==========================================================
# IMPROVED SOCIAL GROUP OPTIMIZATION (ISGO) + FUZZY C-MEANS
# + 5 VALIDITY INDICES
# ==========================================================
...
n_agents = 20
max_iter = 30
alpha = 0.5   # social learning factor
beta = 0.3    # self-learning factor
...
# ==========================================================
# 🔹 4. IMPROVED SOCIAL GROUP OPTIMIZATION (ISGO)
# ==========================================================
...
for iteration in range(max_iter):
    ...
    mean_position = np.mean(agents, axis=0)
    ...
    for i in range(n_agents):
        ...
        # Social learning + self improvement
        new_position = (
            agents[i]
            + alpha * r1 * (global_best - agents[i])
            + beta * r2 * (mean_position - agents[i])
        )
...
# ==========================================================
# 🔹 5. FINAL FCM USING ISGO-OPTIMIZED CENTROIDS
# ==========================================================
