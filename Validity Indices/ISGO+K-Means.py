# ==========================================================
# ISGO (Improved Social Group Optimization) + K-MEANS
...
n_agents = 20
max_iter = 30
alpha = 0.5   # attraction to global best
beta = 0.3    # attraction to group mean
...
# ==========================================================
# 🔹 8. FINAL K-MEANS USING ISGO CENTROIDS
# ==========================================================
...
print("\n============= ISGO + K-MEANS CLUSTERING RESULTS =============")
