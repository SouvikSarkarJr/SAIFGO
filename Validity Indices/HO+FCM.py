# ==========================================================
# HIPPO OPTIMIZATION (HO) + FUZZY C-MEANS
# + 5 VALIDITY INDICES
# ==========================================================
...
for iteration in range(max_iter):
    ...
    for i in range(n_agents):
        ...
        # Exploration phase (hippos moving in river)
        exploration = r1 * (global_best - agents[i])

        # Defense phase (random disturbance)
        disturbance = r2 * (np.random.randn(n_clusters, n_features))

        new_position = agents[i] + exploration + disturbance
...
# ==========================================================
# 🔹 5. FINAL FCM USING HO-OPTIMIZED CENTROIDS
# ==========================================================
