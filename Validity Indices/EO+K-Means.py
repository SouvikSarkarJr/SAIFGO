# ==========================================================
# EO (ENERGY OPTIMIZATION) + K-MEANS
...
# 🔹 1. SETTINGS
# ==========================================================
file_path = "/Users/souvik/Documents/Project-II/Data-sets/Iris.csv"
n_clusters = 3
...
for iteration in range(max_iter):
    ...
    for i in range(n_agents):
        ...
        new_position = (
            global_best
            + (agents[i] - global_best) * np.exp(-lambda_val * iteration / max_iter)
            + r * (np.random.rand(n_clusters, n_features) - 0.5)
        )
...
# ==========================================================
# 🔹 8. FINAL K-MEANS USING EO CENTROIDS
# ==========================================================
