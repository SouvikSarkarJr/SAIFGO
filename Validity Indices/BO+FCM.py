# ==========================================================
# BILLIARDS OPTIMIZATION (BO) + FUZZY C-MEANS (FCM)
# + 5 VALIDITY INDICES
# ==========================================================
...
# ==========================================================
# 🔹 4. BILLIARDS OPTIMIZATION (BO)
# ==========================================================

# Initialize balls (agents)
...
for iteration in range(max_iter):
    ...
    for i in range(n_agents):
        ...
        # Billiards movement (reflection-based random motion)
...
# ==========================================================
# 🔹 5. FINAL FCM USING BO-OPTIMIZED CENTROIDS
# ==========================================================
