# ==========================================================
# META-OOD OPTIMIZER (MOOD) + K-MEANS
...
for iteration in range(max_iter):
    ...
    ood_anchors = agents[sorted_indices[-n_ood:]]
...
# ==========================================================
# 🔹 8. FINAL K-MEANS USING META-OOD CENTROIDS
# ==========================================================
...
print("\n============= MOOD + K-MEANS CLUSTERING RESULTS =============")
