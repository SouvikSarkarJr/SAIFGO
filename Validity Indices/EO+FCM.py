# ==========================================================
# ENERGY OPTIMIZATION (EO) + FUZZY C-MEANS
# + 5 VALIDITY INDICES
# ==========================================================
...
# 🔹 1. SETTINGS
# ==========================================================
file_path = "/Users/souviksarkarjr./Downloads/Datasets/Bank.csv" #Change
n_clusters = 3
m = 2.0
...
for iteration in range(max_iter):
    ...
    equilibrium_pool = agents[np.argsort(fitness_scores)[:4]]
    eq_mean = np.mean(equilibrium_pool, axis=0)

    for i in range(n_agents):

        lambda_param = np.random.rand()
        r = np.random.rand()

        F = lambda_param * (eq_mean - agents[i])
        G = r * (best_solution - agents[i])

        new_position = agents[i] + F + G
...
# ==========================================================
# 🔹 5. FINAL FCM USING EO-OPTIMIZED CENTROIDS
# ==========================================================
